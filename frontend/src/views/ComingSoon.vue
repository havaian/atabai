<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-[#312e81] to-[#0c4a6e] relative overflow-hidden">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center max-w-lg mx-auto mb-12">
                        ...
                        <button @click="openMail"
                            class="text-white/80 hover:text-white bg-white/10 font-medium py-3 px-6 rounded-lg hover:bg-white/20 transition-colors inline-flex items-center justify-center">
                            <MailIcon size="40" className="mr-2" />
                            {{ $t('comingSoon.email') }}
                        </button>
                    ...
                    <div class="flex justify-center">
                        <router-link to="/"
                            class="text-white/80 hover:text-white bg-white/10 font-medium py-4 px-8 rounded-lg hover:bg-white/20 transition-colors inline-flex items-center">
...
/* Slow spin animation for the cog */
@keyframes spin-slow {
    from {
