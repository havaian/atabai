            ...
            <div class="bg-neutral-100 min-w-60 basis-96 px-7 py-8 rounded-32 md:px-5 md:w-full">
              ...
              <div class="bg-white p-6 rounded-20">
                <div class="space-y-4">
                  ...
                  <button class="btn-primary bg-black text-white border-black border-1 hover:bg-transparent hover:text-black hover:border-black w-full">
                    {{ $t('common.download') }}
                  </button>
                </div>
              </div>
            ...
            <section
              ...
              <div class="flex w-full max-w-3xl flex-col items-center md:max-w-full">
                ...
                <div class="btn-mask-container mt-12 md:mt-10">
                  <button @click="authStore.isAuthenticated ? $router.push('/dashboard') : authStore.login()"
                     class="btn-primary bg-white text-black border-white border-1 hover:bg-transparent hover:text-white hover:border-white min-w-60 min-h-14 px-7">
                    {{ $t('cta.button') }}
                  </button>
                </div>
              </div>
